...
const content = {
  texts: {
    ...
    ofertas: {
      miniTag: "OFERTAS RELÂMPAGO",
      title: "Tendas com condição especial por tempo limitado",
      subtitle:
        "Modelos 5x5 e 10x10 com pronta entrega, envio para todo o Brasil e pagamento facilitado via Pix ou transferência.",
    },
    features: {
    ...
    cta: {
      ...
      title: (
        <p className="">
          Tendas a pronta entrega ou fabricação de tendas ? Fale com a Ramom
          Tendas!
        </p>
      ),
      subtitle:
