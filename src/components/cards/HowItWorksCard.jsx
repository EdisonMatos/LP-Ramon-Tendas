...
export default function HowItWorksCard({
  ...
  const Content = (
    <div className="flex flex-col items-center justify-center h-auto transition desktop1:items-start font-mainFont desktop1:hover:scale-110">
      <div className="bg-primary mb-[32px] p-[25px] flex justify-center items-center rounded-full h-[48px] w-[48px] text-white  text-title1 font-secondFont font-bold">
        {number}
      </div>
      <h1 className="text-[20px] text-primary font-secondFont font-bold mb-[24px]">
        {title}
      </h1>
      <p className="text-[16px] font-secondFont text-primary opacity-70 text-center desktop1:text-left w-full">
        {description}
      </p>
    </div>
  );
